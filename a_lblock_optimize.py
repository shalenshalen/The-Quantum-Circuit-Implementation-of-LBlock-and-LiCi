...
def MAJOR(eng, K, X, L, R, k):
    ...
    for round in range(0, 32, 2):
        ...
        Toffoli_gate(eng, L[1], L[3], R[10])
        Toffoli_gate(eng, L[4], L[7], R[2])
        Toffoli_gate(eng, L[10], L[11], R[12])
        Toffoli_gate(eng, L[13], L[14], R[7])
        Toffoli_gate(eng, L[18], L[19], R[25])
        Toffoli_gate(eng, L[22], L[23], R[17])
        Toffoli_gate(eng, L[24], L[27], R[30])
        Toffoli_gate(eng, L[28], L[31], R[22])
        ...
        Toffoli_gate(eng, R[1], R[3], L[10])
        Toffoli_gate(eng, R[4], R[7], L[2])
        Toffoli_gate(eng, R[10], R[11], L[12])
        Toffoli_gate(eng, R[13], R[14], L[7])
        Toffoli_gate(eng, R[18], R[19], L[25])
        Toffoli_gate(eng, R[22], R[23], L[17])
        Toffoli_gate(eng, R[24], R[27], L[30])
        Toffoli_gate(eng, R[28], R[31], L[22])
